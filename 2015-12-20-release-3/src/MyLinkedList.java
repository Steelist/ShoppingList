...
public class MyLinkedList<T> {
    ...
    /**
     * Holds the main pieces for a linked list to work.
     * 
     * Each element has a link to the next one and each one contains a
     * String type item and its int type quantity.
     * 
    ...
    /**
     * Is the first element in the linked list.
     * 
     * The newest addition to the list is always marked as first and all
     * previous ones are linked to it.
     */
    private Element<T> first;
    
    /**
     * Shows how many items there are in the current linked list.
     */
    private int size;
    
    /**
     * Adds an item to the linked list and links it to the previous one.
     * 
     * If the first item is given then sets the link to previous one null and
     * just sets the item (content). Adds plus one to the size attribute.
     * 
     ...
     * 
     * If any duplicates are found adds the given amount to the existing item's
     * quantity and returns true. If it doesn't find a duplicate then just
     * returns false.
     * 
    ...
    /**
     * Removes the element from the index location.
     * 
